...
**1.** Before using the app **ICAI**, let's thank to [Jalecom](https://github.com/Jalecom/AJ_HC1703L_Teardown) for providing the tools to "bypass" the imposed restrictions.
